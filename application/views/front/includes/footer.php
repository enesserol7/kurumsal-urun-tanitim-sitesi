...
<script type="text/javascript" src="<?php echo base_url("assets/front/"); ?>js/jquery.scrollbar.js"></script>
                ...
                if (textLength > 1 || textLength2 > 1) {
                    ...
                    $.getJSON("/urunler/UrunKelimeAra?kelime=" + e + "&dildurum=" + txtdilsec.value, function (result) {
                        ...
                        $.each(result, function (i, field) {
                            ...
                            $(".searchbox>ul").append("<li onclick=\"kelimeyaz(this.innerHTML);\">" + field.urun_adi + " <span>(" + field.Kategori_adi + ")</span></li>");
                        });
