            ...
            <div>
                ...
                <div class="scrollbar-rail">
                    <?php $dil = "TR"; $veri = urunadi($dil); foreach ($veri as $veri) { ?>
                        <div id="cbKutular"><a href="javascript:void(0);" class="list-group-item"><input type="checkbox" name="brand" class="item_filter brand" value="<?php echo $veri["urun_seo"]; ?>" id="<?php echo $veri["urun_seo"]; ?>" ><span><?php echo $veri["urun_adi"]; ?></span></a> </div>
                    <?php } ?>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="scrollbar-rail">
                    <?php $dil = "TR"; $veri = urunkullanimyeri($dil); foreach ($veri as $veri) { ?>
                        <div id="cbKutular"><a href="javascript:void(0);" class="list-group-item"><input type="checkbox" name="kulyeri" class="item_filter kulyeri" value="<?php echo $veri["sef"]; ?>" id="<?php echo $veri["sef"]; ?>"><span><?php echo $veri["kullanim_yeri"]; ?></span></a> </div>
                    <?php } ?>
                </div>
            </div>
            <div>
                ...
                <div class="scrollbar-rail">
                    <?php $sayi = 1; $dil = "TR"; $veri = urunolcu($dil); foreach ($veri as $veri) { ?>
                        <div id="cbKutular"><a href="javascript:void(0);" class="list-group-item"><input type="checkbox" name="size" class="item_filter size" value="<?php echo $veri["urun_olcu"]; ?>" id="<?php echo $veri["urun_olcu"]; ?>"><span><?php echo $veri["urun_olcu"]; ?></span></a> </div>
                    <?php } ?>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="scrollbar-rail">
                    <?php $sayi = 1; $dil = "TR"; $veri = urunrenk($dil); foreach ($veri as $veri) { ?>
                        <div id="cbKutular"><a href="javascript:void(0);" class="list-group-item"><input type="checkbox" name="colour" class="item_filter colour" value="<?php echo $veri["urun_rengi"]; ?>" id="<?php echo $veri["urun_rengi"]; ?>"><span><?php echo $veri["urun_rengi"]; ?></span></a> </div>
                    <?php } ?>
                </div>
            </div>
...
<script src="<?php echo base_url("assets/front/"); ?>js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function KategoriSecim()
        {
            ...
            {
                window.location = "<?php echo base_url("urunler/"); ?>" + strUser;
            }
...
#loaderpro{text-align:center; background: url('loader.gif') no-repeat center; height: 150px;}
    ...
    $(document).ready(function(){
        $('.item_filter').click(function(){
            ...
            $.ajax({
                url: "<?php echo base_url('urunlerliste/');echo $sonuc?>",
                type:'post',
                data:{colour:colour,brand:brand,size:size,kulyeri:kulyeri},
