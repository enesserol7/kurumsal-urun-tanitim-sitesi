  ...
  <section class="content">
      <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url('panel/haberduzenleme'); ?>" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Haber Title</label>

                  <div class="col-sm-6">
                    <input type="text" name="title" value="<?php echo $bilgi['haber_adi']; ?>" class="form-control" placeholder="Haber Başlık">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <select class="form-control" name="katID">
                      <?php $bilgim = haberkategori(); foreach ($bilgim as $bilgim) { if($bilgim['id'] == $bilgi['kategori_id']) { ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <img src="<?php echo base_url($bilgi['haber_resim']); ?>" class="img img-responsive profile-user-image" alt="">
