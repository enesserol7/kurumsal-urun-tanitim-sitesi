...
<head>
  ...
  <title>Duratiles | Yönetici Giriş Formu</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url("assets/panel/"); ?>plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url("panel/girisyap"); ?>" method="post">
